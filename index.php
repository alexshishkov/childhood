...
?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                        ...
                        <?php the_field('about_discription'); ?>
                        </div>
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title"><?php the_field('our_camands'); ?></div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('photo_comands'); ?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('phone1'); ?>"><?php the_field('phone1'); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('phone2'); ?>"><?php the_field('phone2'); ?></a>
                                    </div>
                                </div>
                            </div>
